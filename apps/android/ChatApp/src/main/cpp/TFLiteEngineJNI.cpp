...
Java_com_chatgptlite_wanted_data_whisper_engine_WhisperEngineNative_createTFLiteEngine(JNIEnv *env, jobject thiz) {
...
Java_com_chatgptlite_wanted_data_whisper_engine_WhisperEngineNative_loadModel(JNIEnv *env, jobject thiz, jlong nativePtr, jstring modelPath, jboolean isMultilingual) {
...
Java_com_chatgptlite_wanted_data_whisper_engine_WhisperEngineNative_freeModel(JNIEnv *env, jobject thiz, jlong nativePtr) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
    engine->freeModel();
    delete engine;
}
...
Java_com_chatgptlite_wanted_data_whisper_engine_WhisperEngineNative_transcribeBuffer(JNIEnv *env, jobject thiz, jlong nativePtr, jfloatArray samples) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
...
JNIEXPORT jstring JNICALL
Java_com_chatgptlite_wanted_data_whisper_engine_WhisperEngineNative_transcribeFile(JNIEnv *env, jobject thiz, jlong nativePtr, jstring waveFile) {
    TFLiteEngine *engine = reinterpret_cast<TFLiteEngine *>(nativePtr);
