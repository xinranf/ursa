...
public class BackgroundRecorder {
    public static final String TAG = "BackgroundRecorder";
    ...
    private void threadFunction() {
        try {
            ...
            int bufferSize30Sec = bufferSize1Sec * 1;
            ...
            while (mInProgress.get() && (totalBytesRead < bufferSize30Sec)) {
                ...
                if (bytesRead > 0) {
                    ...
                    // Reset the buffer if it exceeds the limit
                    if (buffer30Sec.position() >= bufferSize30Sec) {
                        buffer30Sec.clear(); // Clear the buffer to continue recording
                    }
